...
с CDN): рендер и события доступны, а кнопка «Экспорт в PDF» — неактивна
(в подсказке — как включить). Чтобы включить PDF, соберите кастомный CanvasKit
(ниже) — кнопка станет активной.
